...
import useTheme from '@/hooks/clock/useTheme'
import useSize from '@/hooks/clock/useSize'
// import DaylightIcon from './daylight-icon'

type ClockSizes = 'small' | 'medium' | 'large'
...
const AnalogClock: FC<AnalogClockProps> = ({
  ...
  return (
    <div className="flex w-full flex-wrap items-center justify-center mb-6">
      ...
      <div className="group relative flex items-center justify-center text-sm">
